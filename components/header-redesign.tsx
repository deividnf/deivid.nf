      ...
      >
        ...
        <div className="hidden md:flex">
          <div className="flex w-full max-w-fit items-center gap-3 rounded-full border border-neutral-400 bg-white px-4 py-2">
            ...
            <Button
              ...
              variant="sweep"
              size="sm"
              className="ml-2 flex-shrink-0 rounded-full border border-blue-700 bg-blue-500 px-3 py-1 text-xs font-semibold text-blue-50"
            >
              <span className="btn-sweep-content">Contato</span>
            </Button>
          </div>
        </div>
        ...
        <div className="md:hidden">
          <Button
            onClick={onOpenModal}
            variant="sweep"
            className="rounded-full border border-blue-700 bg-blue-500 px-4 py-2 text-xs font-semibold text-blue-50"
          >
            <span className="btn-sweep-content">Contato</span>
          </Button>
        </div>
